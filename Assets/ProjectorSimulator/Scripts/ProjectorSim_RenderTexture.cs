...
public class ProjectorSim_RenderTexture : MonoBehaviour
{
    ...
    void Awake ()
    {
        ...
        if (EditorApplication.isPlaying)
        {
            ...
            cookie = new Cookie(new CookieData(shift_v, shift_h, keystoneH, keystoneV, throwRatio, aspectRatio), cookieSizeInt, lights[0], lights[1], lights[2], forceLegacyMethod, renderTexture, colour, true);
        ...
        else // EDITOR EDIT MODE - only calculate the white cookie
        {
            ...
            cookie = new Cookie(new CookieData(shift_v, shift_h, keystoneH, keystoneV, throwRatio, aspectRatio), cookieSizeInt, lights[0], lights[1], lights[2], forceLegacyMethod, null, colour);
        }
#endif
        AssignLightCookies();
    }
