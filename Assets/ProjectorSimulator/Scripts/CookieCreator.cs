...
public class Cookie
{
    ...
    public Cookie(CookieData cookieData, int cookieSize, Light red, Light green, Light blue, bool forcePixelByPixel, Texture imageToProject = null, bool colour = false, bool enableLiveUpdate = false)
    {
    ...
    void UpdateCookie(bool doBlacks = true)
    {
        ...
        else // shader-based approach
        {
            ...
            */
            ...
            Graphics.Blit(projectedImage, redCookie as RenderTexture, singlePassR);
            Graphics.Blit(projectedImage, greenCookie as RenderTexture, singlePassG);
            Graphics.Blit(projectedImage, blueCookie as RenderTexture, singlePassB);
        }
